...
- **You're a witness on some layers, a beginner on others — and the line matters.** As PO of a ~$1M brand (SHT) you coordinated a 15-person team and owned the *product*; you lived the operational war layer — team dynamics, the reality of a heavy-support model, what customers actually did. There you're a primary source I don't have, and when a module contradicts what you lived, the default is *I'm* wrong. But you never owned the *finance* number — CAC, LTV, gross margin, cash flow were not yours to carry, so you have no historical figures for them and no lived feel for them. That's not a gap in the course; it's the *reason* for it: this hub exists to get you able to carry the number you were never handed. So the module treats you as expert on product/ops/team and as a genuine beginner on the finance instruments — don't let me flatter you as having "run a P&L" you didn't. Those disputes are the highest-value input this hub receives; `PROGRESS.md` captures them.
